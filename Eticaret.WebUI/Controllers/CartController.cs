...
namespace Eticaret.WebUI.Controllers
{
    public class CartController : Controller
    {
        ...
        public IActionResult Add(int ProductId, int quantity = 1)
        {
            ...
            string returnUrl = Request.Headers["Referer"].ToString(); //Bulunduğu sayfada kal
            if (string.IsNullOrEmpty(returnUrl))
            {
                returnUrl = Url.Action("Index", "Home"); // Varsayılan olarak anasayfaya yönlendir
            }
        ...
        public async Task<IActionResult> CheckOut(string CardNumber, string CardMonth, string CardYear, string CVV, string DeliveryAddress, string BillingAddress)
        {
            ...
            var siparis = new Order
            {
                ...
                OrderState = 0, //İlk başta tüm siparişlerin ilk pozisyonu 0; yani "Onay Bekliyor" enum'ı olacak
                OrderLines = []
            };
